...
Exercise 8.1
Create an application which consists of a card. By default the card should not be expanded. It should be expandable.
After it has been expanded, it should automatically close after three seconds.
*/
