...
Exercise 1.4 The application consists of a three checkboxes: 
one for mouse down, one for mouse motion and one for mouse wheel event listening registration.
*/
