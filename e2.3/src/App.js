...
Exercise 2.3 
Build an interface for editing Person information: 
first name
last name
birth place
birth country
Person information should be visible in the main window but editable only via the dialogs opened by clicking buttons.
*/
      ...
      <div> 
        ...
        <div className= {this.props.classes.personInfo}>
          ...
          <div className={this.props.classes.personInfoButtons}>
            ...
            <Button variant="outlined" className={classes.buttonPersonInfo} onClick={this.handleClickOpen('birthYear')}>
                Edit birth year
            </Button>
          </div>
        </div>
