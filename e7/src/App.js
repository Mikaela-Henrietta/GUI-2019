...
Exercise 7.1
Take one of your earlier implementations of Person information editing application (e.g, 6.1) and internationalize it:
translate the user interface to another language in addition to English.
With React, include an option into interface for the user to choose the language.
*/
